    ...
    <div className="space-y-6">
      {sessions.map((session) => {
        ...
        return (
          <Card
            key={session.id}
            className="overflow-hidden border-border/40 transition-all duration-300 hover:shadow-sm"
          >
                      ...
                      <Badge
                        ...
                        className={
                          session.status === "scheduled"
                            ? "text-green-500 border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-900/30"
                            : session.status === "completed"
                            ? "text-blue-500 border-blue-200 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-900/30"
            ...
            <CardContent className="px-6 pb-6 pt-0">
              ...
              {session.status === "scheduled" && "meetingLink" in session && (
